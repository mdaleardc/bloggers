...
import { createNewAuthor, updateAuthor, deleteAuthor } from "@/lib/firebase/author/write";
...
// create data
  const handleCreate = async () => {
    ...
    try {
      ...
      // Create author with image URL
      await createNewAuthor({ ...data, imageUrl });
...
// update data
  ...
  try {
    ...
    // Update author with new data and image URL
    await updateAuthor({ ...data, imageUrl });
...
// delete data
  ...
  const fetchData = async (id) => {
    ...
    try {
      ...
      throw new Error(`No author found from ${id}`);
      }
    } catch (err) {
      setError(err.message);
    }
